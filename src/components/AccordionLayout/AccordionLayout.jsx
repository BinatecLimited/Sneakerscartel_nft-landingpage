...
const AccordionLayout = ({ title, children, index, activeIndex, setActiveIndex }) => {
    ...
    return (
    <>
        <div onClick={() => handleSetIndex(index)} className='flex w-1/2 justify-between p-2 mt-2 rounded bg-sky-400'>
            <div className='flex w-1/2 justify-between p-2 mt-2 rounded bg-sky-400'>
                <div className='flex'>
